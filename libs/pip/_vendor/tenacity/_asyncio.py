...
from libs.pip import AttemptManager
from libs.pip import BaseRetrying
from libs.pip import DoAttempt
from libs.pip import DoSleep
from libs.pip import RetryCallState
